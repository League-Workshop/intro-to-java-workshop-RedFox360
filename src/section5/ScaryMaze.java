...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	maze = ImageIO.read(getClass().getResource("pdxmaze.png"));
	...
	private void showScaryImage() {
		try {
			maze = ImageIO.read(getClass().getResource("ghost.png"));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + "ghost.png");
		}
		repaint();
	}
